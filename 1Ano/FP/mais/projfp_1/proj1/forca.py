...
def remover_acentos(palavra):
     acentos2 = {'á':'a','à':'a','â':'a','ã':'a','é':'e','è':'e','ê':'e','í':'i','ì':'i','î':'i','ó':'o','ò':'o','ô':'o','õ': 'o','ú':'u','ù':'u','û':'u','ç':'c'}
     for acentos2, letra in acentos2.items():
        palavra1 = palavra.replace(acentos2, letra)
        return palavra1
