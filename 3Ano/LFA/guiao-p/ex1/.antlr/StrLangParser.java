...
public class StrLangParser extends Parser {
	...
	public static class StatEmptyContext extends StatContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof StrLangListener ) ((StrLangListener)listener).enterStatEmpty(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof StrLangListener ) ((StrLangListener)listener).exitStatEmpty(this);
		}
	}
	...
	public static class ExprReplaceContext extends ExprContext {
		...
		public List<TerminalNode> STRING() { return getTokens(StrLangParser.STRING); }
		public TerminalNode STRING(int i) {
			return getToken(StrLangParser.STRING, i);
		}
